...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: communitycoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: communitycoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 7643 or testnet: 17643)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 7644 or testnet: 17644)") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the CommunityCoin Wiki for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single CommunityCoin process is using the data directory.
